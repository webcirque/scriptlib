...
list=list.split("\n");notes[donum].innerHTML="";for(let dinum=0;dinum<list.length;dinum++){if(list[dinum].search("#1:")==0){notes[donum].innerHTML+="<div class=\"t1\">"+list[dinum].replace("#1:","")+"</div>";}else if(list[dinum].search("#2:")==0){notes[donum].innerHTML+="<div class=\"t2\">"+list[dinum].replace("#2:","")+"</div>";}else if(list[dinum].search("#3:")==0){notes[donum].innerHTML+="<div class=\"t3\">"+list[dinum].replace("#3:","")+"</div>";}
